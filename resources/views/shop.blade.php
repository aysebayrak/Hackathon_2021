<x-app-layout title="HAAL - Mağaza">
    <div class="container w-3/4 mx-auto pt-10">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                        <img class="object-cover w-full h-full rounded-full" src="/storage/{{$product->photo_url}}" alt="" loading="lazy" />
